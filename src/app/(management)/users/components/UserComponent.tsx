...
const UserList: React.FC = () => {
  ...
  return (
    <Grid container spacing={2} style={{ backgroundColor: "#F1F5F9" }}>
      <Grid item xs={12} sm={6} md={4} lg={2.4}>
        <div className="group bg-gray-900/30 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/40 hover:smooth-hover" style={{ marginTop: '0.5rem', marginLeft: '1rem', paddingTop: '9rem', paddingBottom: '9rem', paddingLeft: 0, paddingRight: 0, width: '15.5rem' }}>
          <a
