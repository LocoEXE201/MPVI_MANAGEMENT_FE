...
const SupplierComponent = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#F1F5F9" }}>
      ...
      >
        <InputLabel className="mb-2">Tên Nhà Cung Cấp</InputLabel>
        <input
        ...
        />
        <InputLabel className="mb-2">Địa Chỉ</InputLabel>
        <input
        ...
        />
        <InputLabel className="mb-2">Số Điện Thoại</InputLabel>
        <input
          className="border mb-5 px-5 py-2 w-2/3"
        ...
        />
        <InputLabel className="mb-2">Người Đại Diện</InputLabel>
        <input
          className="border mb-5 px-5 py-2 w-2/3"
        ...
        />
        <InputLabel className="mb-2">Hình Thức Cung Cấp</InputLabel>
        <select
        ...
        <InputLabel className="mb-2">Phương Thức Liên Lạc</InputLabel>
        <textarea
        ...
        <div className="flex justify-between">
          <Button onPress={unhiddenNewContactdiv} className="border text-red-500">Đóng</Button>
          <Button onPress={createNSupplier} className="border text-blue-500">Tạo mới</Button>
        </div>
      </div>
